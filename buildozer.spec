...
requirements = python3,kivy==2.1.0, kivymd==1.1.1, sdl2_ttf==2.0.15, pillow, requests,numpy,sounddevice,wavio,geopy,tensorflow,
...
android.permissions = INTERNET, ACCESS_NETWORK_STATE, ACCESS_WIFI_STATE, RECORD_AUDIO, MANAGE_EXTERNAL_STORAGE, SEND_SMS, ACCESS_FINE_LOCATION, ACCESS_COARSE_LOCATION
